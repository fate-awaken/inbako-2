!(function (t, e) {
	...
	function V() {
		var t = h($().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(
				function (t, e) {
					return (
		...
		return new Promise(function (t) {
			...
			(Xt.restoreFocusTimeout = setTimeout(function () {
				Xt.previousActiveElement && Xt.previousActiveElement.focus
					? (Xt.previousActiveElement.focus(), (Xt.previousActiveElement = null))
	...
	function pe(t, e, n, o) {
		...
		n
			...
			ht(
				[document.documentElement, document.body],
				[Y.shown, Y["height-auto"], Y["no-backdrop"], Y["toast-shown"], Y["toast-column"]]
			);
	}
	function fe(t) {
		var e,
	...
	function we(t) {
		...
		(e = t).inputValidator ||
			...
			((n = t).target &&
				...
				(_('Target parameter is not valid, defaulting to "body"'), (n.target = "body")),
